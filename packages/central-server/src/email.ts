...
const transport = NodeMailer.createTransport(transportOptions, transportDefaults);
transport.use(
  "compile",
 ...
 * @returns
 */
export function getVerifyUrl(request: FastifyRequest, verificationCode: string) {
